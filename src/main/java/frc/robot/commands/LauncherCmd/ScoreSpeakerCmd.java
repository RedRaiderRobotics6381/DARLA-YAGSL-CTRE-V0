...
public class ScoreSpeakerCmd extends Command {
  ...
  public ScoreSpeakerCmd(Launcher m_Launcher) {
  ...
  public void execute() {
    ...
    if (Math.abs(m_Launcher.m_launchWheelLeaderR.getEncoder().getVelocity()) >= 5500) {
      m_Launcher.setFeedWheel(LauncherConstants.kLauncherSpeed);
      noteLaunched = true;
    }
